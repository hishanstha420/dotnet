namespace EnumClass
{
    ...
    class program
    {
        public static void Main()
        {
            ...
            {
                new Staff(1,"Aayush","Kumar","Raut","female",22,Staff.designation.CEO),
                new Staff(1,"Aayush","Kumar","Raut","female",22,Staff.designation.Accountant),
                new Staff(1,"Aayush","Kumar","Raut","male",22,Staff.designation.CEO),
                new Staff(2,"Mahesh","","Chapagain","male",29,Staff.designation.Manager)
            };
            var aa=from s in staff_details where s.gender=="female" select s;
            foreach (var a in aa)
            {
